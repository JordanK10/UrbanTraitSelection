...
COVARIANCE_MIN_GRO <- -20  # Manual minimum bound
COVARIANCE_MAX_GRO <- 20  # Manual maximum bound
...
COVARIANCE_MIN_INC <- -35  # Manual minimum bound
...
COVARIANCES_MAP_FILE <- "output_maps/chicago_community_maps_covars_bg.pdf"
...
if(COV_INC_TERM_USE_DATA_DRIVEN_LIMITS) {
  ...
  cov_term_limits <- analyze_data_distribution(
    map_data, 
    "Transmitted_Sel_tr_to_cm_inc_PNC_ct", 
    additional_data, 
    "Transmitted_Sel_tr_to_cm_inc_PNC_ct"
  )
...
if(COV_GRO_TERM_USE_DATA_DRIVEN_LIMITS) {
  ...
  cov_gro_term_limits <- analyze_data_distribution(
    map_data, 
    "Transmitted_Sel_tr_to_cm_pop_PNC_ct", 
    additional_data, 
    "Transmitted_Sel_tr_to_cm_pop_PNC_ct"
  )
...
required_vars <- c("Transmitted_Sel_tr_to_cm_inc_PNC_ct",   "Transmitted_Sel_tr_to_cm_pop_PNC_ct" )
