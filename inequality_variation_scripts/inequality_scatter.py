...
def create_scatter_plot(x_data, y_data, color_data, x_label, y_label, color_label, title, filename, size_data=None, label=None):
    ...
    full_filename = f"inequality_scatter_plots/{filename}"
...
if __name__ == "__main__":
    ...
    print("1. inequality_scatter_plots/rel_growth_vs_income_pnc.pdf")
    print("2. inequality_scatter_plots/rel_growth_vs_population_pnc.pdf") 