...
def create_gini_scatter_plot(merged_data):
    ...
    # Save plot
    plt.tight_layout()
    os.makedirs("inequality_scatter_plots", exist_ok=True)
    filename = "inequality_scatter_plots/gini_change_vs_income_pnc.pdf"
...
def create_gini_scatter_plot_tract(merged_data):
    ...
    plt.tight_layout()
    os.makedirs("inequality_scatter_plots", exist_ok=True)
    filename = "inequality_scatter_plots/gini_change_vs_income_pnc_tract.pdf"
    plt.savefig(filename, dpi=300, bbox_inches='tight', facecolor='white')
    plt.close()
    print(f"Saved: {filename}")
...
def create_transmitted_vs_bg_gini_scatter_plot(merged_data):
    ...
    plt.tight_layout()
    plt.savefig("inequality_scatter_plots/transmitted_vs_bg_gini.pdf", dpi=300, bbox_inches='tight', facecolor='white')
    plt.close()
    print("Saved: inequality_scatter_plots/transmitted_vs_bg_gini.pdf")
...
def create_selection_vs_tr_gini_scatter_plot(merged_data):
    ...
    plt.tight_layout()
    plt.savefig("inequality_scatter_plots/selection_vs_tr_gini.pdf", dpi=300, bbox_inches='tight', facecolor='white')
    plt.close()
    print("Saved: inequality_scatter_plots/selection_vs_tr_gini.pdf")
...
if __name__ == "__main__":
    ...
    print("  - Block Group: inequality_scatter_plots/gini_change_vs_income_pnc.pdf")
    print("  - Tract Level: inequality_scatter_plots/gini_change_vs_income_pnc_tract.pdf") 
    print("  - Transmitted vs BG Gini: inequality_scatter_plots/transmitted_vs_bg_gini.pdf")
    print("  - Selection vs TR Gini: inequality_scatter_plots/selection_vs_tr_gini.pdf") 