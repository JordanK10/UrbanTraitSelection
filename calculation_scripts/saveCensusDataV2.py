...
def genAggregatedDFs(aggs,data_to_aggregate, input_level, variables, year, community_mapping_df):
    ...
    if input_level == 'bg':
        ...
        # --- MODIFIED: Instead of dropping, fill missing communities with county name ---
...
def fetchIncomeData(variable,y=False): # Remove unused 'y' parameter later if confirmed unused
    ...
    try:
        ...
        # Create county-specific community names once, before the loop.
...
def main():
    ...
    save_data(incomes, 'calculation_scripts/data/census_data1.pkl')
