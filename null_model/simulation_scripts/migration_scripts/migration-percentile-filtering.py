...
def main():
    ...
    df_2019_simulated = apply_internal_migration(df_2014_external, df_2019_filtered)
    ...
    df_2014_filtered.to_csv('null_model/simulation_results/migration_percentile/Census-Data-2014_80.csv', index=False)
    print(f"✓ Saved df_2014_filtered to 'null_model/simulation_results/migration_percentile/Census-Data-2014_80.csv'")
    
    df_2019_simulated.to_csv('null_model/simulation_results/migration_percentile/Simulated-Data-2019_80.csv', index=False)
    print(f"✓ Saved df_2019_simulated to 'null_model/simulation_results/migration_percentile/Simulated-Data-2019_80.csv'")

    # Return final results
    print("\n" + "="*60)
    print("✓ Migration percentile null model complete!")
    print("="*60)
