...
COVARIANCE_MIN_GRO <- -75  # Manual minimum bound
COVARIANCE_MAX_GRO <- 75  # Manual maximum bound
...
COVARIANCE_MIN_INC <- -50  # Manual minimum bound
COVARIANCE_MAX_INC <- 50   # Manual maximum bound
...
# Output file names
COVARIANCES_MAP_FILE <- "output_maps/chi_msa_maps_covars.pdf"
...
cum_sel_gro_ratio_map <- create_variable_map(
  map_data, 
  "cum_sel_gro_ratio", 
...
cum_sel_inc_ratio_map <- create_variable_map(
  map_data, 
  "cum_sel_inc_ratio", 
...
combined_map <-  cum_sel_gro_ratio_map + cum_sel_inc_ratio_map  +
